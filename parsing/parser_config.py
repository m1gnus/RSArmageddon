...
attacks_parser.add_argument("--n-e-file", action = "store", dest = "n_e_file", type = str, default = None, help = "Path to a file containing modulusses and public exponents")
...
cipher_parser.add_argument("--file-padding", action = "store", dest = "filepadding", type = str, default = "pkcs", help = "raw, pkcs, ssl, oaep, x931")
